...
CREATE TABLE `nhaxuatban` (
  `IdNhaXuatBan` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `nhaxuatban` VALUES (1,'NXB Kim Dong','Ha Noi'),(2,'NXB Tre','Ho Chi Minh'),(3,'NXB Giao Duc','Ha Noi'),(4,'NXB Lao Dong','Da Nang'),(5,'NXB Van Hoc','Hue');
